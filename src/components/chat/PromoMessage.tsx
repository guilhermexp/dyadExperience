...
// Predefined message configurations (Pro messages removed for self-hosting)
...
// Array of all available messages for rotation (Pro messages removed for self-hosting)
const ALL_MESSAGES = [
  DIFFERENT_MODEL_TIP,
  REDDIT_TIP,
  REPORT_A_BUG_TIP,
